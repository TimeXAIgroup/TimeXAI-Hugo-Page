  ...
  - block: markdown
    content:
      text: |
        ...
        <img src="/uploads/XAI4TSC.png" alt="Overview of the XAI4TSC evaluation framework" loading="lazy" decoding="async" />
        </div>
        ...
        <a class="research-resource-card__link" href="https://github.com/TimeXAIgroup/XAI4TSC" target="_blank" rel="noopener noreferrer">
        Open framework ↗
        </a>
        </div>
        </article>
        ...
        <article class="research-resource-card">
        <div class="research-resource-card__image">
        <img src="/uploads/eduxai.png" alt="EduXAI interactive web application" loading="lazy" decoding="async" />
        </div>
